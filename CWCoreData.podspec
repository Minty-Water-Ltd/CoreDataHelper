#
#  Be sure to run `pod spec lint CWCoreData.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/chriswunsch00/CWCoreData"
  ...
  s.author             = { "Chris Wunsch" => "chris@mintywater.co.uk" }
  # Or just: s.author    = "Chris Wunsch"
  # s.authors            = { "Chris Wunsch" => "chris@mintywater.co.uk" }
  # s.social_media_url   = "http://twitter.com/ChrisWunsch00"
  ...
  s.source       = { :git => "https://github.com/chriswunsch00/CWCoreData.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "Classes", "CoreDataHelper/Core\ Data\ Stack/**/*.{swift}"
